...
func ProductCommentCriterionProductMgr(db *gorm.DB) *_ProductCommentCriterionProductMgr {
	...
	return &_ProductCommentCriterionProductMgr{_BaseMgr: &_BaseMgr{DB: db.Table("eg_product_comment_criterion_product"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}

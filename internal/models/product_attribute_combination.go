...
func ProductAttributeCombinationMgr(db *gorm.DB) *_ProductAttributeCombinationMgr {
	...
	return &_ProductAttributeCombinationMgr{_BaseMgr: &_BaseMgr{DB: db.Table("eg_product_attribute_combination"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}

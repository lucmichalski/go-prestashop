...
func SpecificPriceRuleConditionGroupMgr(db *gorm.DB) *_SpecificPriceRuleConditionGroupMgr {
	...
	return &_SpecificPriceRuleConditionGroupMgr{_BaseMgr: &_BaseMgr{DB: db.Table("eg_specific_price_rule_condition_group"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}

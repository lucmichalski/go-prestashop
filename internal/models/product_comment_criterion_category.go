...
func ProductCommentCriterionCategoryMgr(db *gorm.DB) *_ProductCommentCriterionCategoryMgr {
	...
	return &_ProductCommentCriterionCategoryMgr{_BaseMgr: &_BaseMgr{DB: db.Table("eg_product_comment_criterion_category"), isRelated: globalIsRelated, ctx: ctx, cancel: cancel, timeout: -1}}
}

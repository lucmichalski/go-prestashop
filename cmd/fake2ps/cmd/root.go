...
var RootCmd = &cobra.Command{
	Use:   "fake2ps",
	Short: "fake2ps is an helper to load realistic fake data into a prestashop database.",
	Long:  `fake2ps is an helper to load realistic fake data into a prestashop database.`,
}

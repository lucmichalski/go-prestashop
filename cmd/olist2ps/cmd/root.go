...
var RootCmd = &cobra.Command{
	Use:   "olist2ps",
	Short: "olist2ps is an helper to load kaggle's olist dataset into a prestashop database.",
	Long: `olist2ps is an helper to load kaggle's olist dataset into a prestashop database.
